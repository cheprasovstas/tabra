package com.showcase.tabra.ui.category;
...
public class CategoryRecyclerViewAdapter extends RecyclerView.Adapter<CategoryRecyclerViewAdapter.ViewHolder> {
    ...
    public CategoryRecyclerViewAdapter(List<PlaceholderItem> items) {
        mValues = items;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(CategoryFragmentItemBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
